...
Now, trying running it for a million steps using the unnormalized `target` as the target.

Make a histogram of the result.  It should look just like target. If it doesn't there is
an error somewhere.  To see a completed function that works see
[https://eriqande.github.io/2020-sisg-mcmc-exercises-eca/006-key.nb.html](https://eriqande.github.io/2020-sisg-mcmc-exercises-eca/006-key.nb.html)
